...
public class MON_RedBat extends Entity{
	...
	public void getImage() {
		up1 = setup("/monster/dvl1_bk1", gp.tileSize, gp.tileSize);
		up2 = setup("/monster/dvl1_bk2", gp.tileSize, gp.tileSize);
		down1 = setup("/monster/dvl1_fr1", gp.tileSize, gp.tileSize);
		down2 = setup("/monster/dvl1_fr2", gp.tileSize, gp.tileSize);
		left1 = setup("/monster/dvl1_lf1", gp.tileSize, gp.tileSize);
		left2 = setup("/monster/dvl1_lf2", gp.tileSize, gp.tileSize);
		right1 = setup("/monster/dvl1_rt1", gp.tileSize, gp.tileSize);
		right2 = setup("/monster/dvl1_rt2", gp.tileSize, gp.tileSize);
	}
